...
const AnimatedButton = ({ to, text }: { to: string, text: string }) => {
    return (
        <Link to={to} offset={-50} className="relative border hover:border-orange-600 duration-500 group cursor-pointer text-orange-50  overflow-hidden h-14 w-56 rounded-md bg-orange-700 p-2 flex justify-center items-center font-extrabold outline-none">
